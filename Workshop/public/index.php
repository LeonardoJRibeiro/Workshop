...
<body style="background-color: #343233">
    ...
    <div class="container">
        <header>
            <div class="row">
                <div class="col-md-5">
                    <div class="d-flex">
                        <img class="ai-img img-fluid mx-auto animated fadeInLeft delay-1s" src="img/ai.png">
                    </div>
                </div>
                <div class="col-md-7">
                    <h5 class="edickao animated fadeInDown">XIV</h5>
                    <h4 class="evenkto animated fadeInDown">Workshop UEG</h4>
                    <h1 class="telma animated fadeInDown">Inteligência Artificial</h1><br>
                    <a href="https://doity.com.br/xiv-workshop-ueg-1" class="btn btn-outline-info btn-lg animated fadeInUp delay-2s">Participe</a>
                </div>
            </div>
        </header>
        <div class="row p-4 infos animated infinite pulse">
    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5 d-flex">
                    ...
                    <div class="mx-auto my-auto p-4">
                        <img class="ai-img img-fluid animated infinite bounce delay-12s" src="img/robot.png">
                    </div>
        ...
        <div class="rodape-down">
            Feito com <i class="fas fa-heart"></i> por <a href="https://github.com/EduardoReisDev" style="color:#2C2A2B;">Eduardo Reis</a>
        </div>
        <!--Rodapé Down-->
